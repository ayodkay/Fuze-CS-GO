...
class MatchesResponseTest {
    ...
    fun testMatchesResponse() {
        ...
        val opponents = listOf(Opponents(opponent1, "team"), Opponents(opponent2, "team"))
        val gameWinner = GameWinner(123, "team")
        ...
        val videogame = VideoGame(1, "Test Game", "test-game")
        val matchesResponse = MatchResponse(
